...
import { warn, curve, logo} from "../../assets/index";
import { Link } from "react-router-dom";
import Marquee from "react-fast-marquee";
import image from "../../DummyData/image";

const BeforeApprovalPage = () => {
  return (
    <>
      <span>
        <Link to="/">
...
<div className="absolute pt-9 md:block sm:hidden hidden">
      ...
      <div className="bg-[#FCFCFC] md:absolute z-30  md:mx-96 mx-6 mt-9 md:mt-0 sm:mt-36 my-2 rounded-xl   flex flex-col justify-center items-center font-DMsans">
        ...
        <p className="text-center md:px-28 mx-3 pt-5 sm:px-20 font-medium">
        You have already filled the sign up details. Please, wait for the admin approval.
        </p>
        <Link
          to="/"
...
export default BeforeApprovalPage;
