...
const navigate = useNavigate();
 ...
 const handleNavigate =()=>{
  ...
  return (
    ...
    <div className="flex justify-center items-center md:mt-0 sm:mt-80 mt-28 ">
      <img src={error} alt="img" className="w-[40vh]   md:w-[70vh]" />
      </div>
      <p className="md:text-[30px] text-[25px] font-semibold">Oops! Looks like you have missed any form</p>
      <p className="md:text-[22px]">Please check previous forms</p>
  
        <button onClick={handleNavigate} className="bg-secondary text-white mt-9 px-[6vh] py-2 rounded-lg hover:bg-transparent hover:border hover:border-secondary hover:text-secondary ">Back to form</button>
