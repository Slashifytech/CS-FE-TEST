...
const ReportList = () => {
  ...
  const fetchReportedIssues = async (page = 1) => {
    ...
    try {
      ...
      const response = await apiurl.get("/get-all-reports", config);
  ...
  return (
    <>
      <span className="fixed">
       ...
       <div className="flex justify-between md:justify-center sm:justify-center  sm:gap-9 gap-9  items-center md:mt-9 sm:mt-9 mt-20 sm:overflow-hidden md:overflow-hidden overflow-x-auto scrollbar-hide whitespace-nowrap w-full sm:ml-24">
             <Link to="/admin/user-reports" className=" md:mx-9 ml-6  shrink-0 w-[60%] sm:w-[40%] md:w-[20%]">
               <p
             ...
             <Link to="/admin/report-lists" className=" shrink-0 mr-9 sm:w-[30%] w-[40%] md:w-[20%]">
